    ...
    <form onSubmit={handleSubmit} className="space-y-6 bg-gray-800 p-6 rounded-lg shadow-lg">
      <div>
        ...
        <textarea
          ...
          className="w-full bg-gray-700 border border-gray-600 rounded-md shadow-sm p-3 focus:ring-purple-500 focus:border-purple-500 text-white placeholder-gray-400"
